...
assets/generated/   # AVIF/WebP/fallback output generated by Sharp
```

The generated HTML pattern is AVIF first, WebP fallback second, and JPEG/PNG fallback in `<img>`.
