...
- After edits: `npm run build` / `npm run build:static` and run the relevant audits. Hostinger production deployment requires explicit approval and the release gate in `CHECKLIST.md`.
